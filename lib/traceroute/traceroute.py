        ...
        if self.source is None:
            ...
            json_file = """
            {
                ...
                "AU": {
                    ...
                    "post_data": {"destination": "_IP_ADDRESS_"}
                },
                "CH": {
                ...
                "RU": {
                    "url": "http://lg.eltel.net/cgi-bin/LG.cgi?r=s&q=t&a=_IP_ADDRESS_"
                },
                "UK": {
                    "url": "http://lg.cerberus.net.uk/lg",
                    "post_data": {"mode": "trace", "input": "_IP_ADDRESS_"}
                },
                "US": {
